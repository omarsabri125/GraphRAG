...
- **Query Interface**: Enter your questions in natural language
...
- **NLP Controller**: Natural language processing and query operations against the knowledge graph
- **Process Controller**: Data processing and management operations

**How it works after pipeline execution**:
1. User sends a query via Streamlit frontend or API
...
- User-friendly query interface for asking questions
